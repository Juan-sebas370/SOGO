...
import { Reservation, Payment, PaymentMethod } from './reservation.model';
import { isoDate, isoDateTime } from '../shared/date-utils';
import { roomsOnFloor } from '../lodging/house';

const F1 = roomsOnFloor(1);
const F2 = roomsOnFloor(2);
...
// catálogo de la casa (lodging/house.ts), ninguna queda reservada dos veces a
// la vez y los huéspedes caben en su capacidad.
// Los códigos RSV-<año>-00108… son los que referencia el seed del módulo TRA.
function seed(): Reservation[] {
  ...
  const rows: SeedRow[] = [
    ...
    // No se dieron
    { guestName: 'Camilo Herrera',         docNumber: '1070809010', phone: '+57 316 789 0123', email: 'camilo.herrera@email.com',   city: 'Colombia - Manizales, Caldas',    reservationType: 'Individual',       lodgingType: 'Habitación',    rooms: ['202'],        adults: 2,  children: 0, infants: 0, checkIn: isoDate(-3),  checkOut: isoDate(-1),  nights: 2, lodgingAmount: 560000,  paid: 0, status: 'No presentada' },
    { guestName: 'Paula Ríos',             docNumber: '1080901020', phone: '+57 315 567 8901', email: 'paula.rios@email.com',       city: 'Colombia - Ibagué, Tolima',       reservationType: 'Individual',       lodgingType: 'Habitación',    rooms: ['103'],        adults: 2,  children: 0, infants: 0, checkIn: isoDate(10),  checkOut: isoDate(12),  nights: 2, lodgingAmount: 480000,  paid: 0, status: 'Cancelada', cancelReason: 'Cambio de planes del huésped' },
    ...
    { guestName: 'Mateo Salazar',          docNumber: '1140607080', phone: '+57 313 246 8101', email: 'mateo.salazar@email.com',    city: 'Colombia - Cartagena, Bolívar',    reservationType: 'Individual',      lodgingType: 'Habitación',    rooms: ['101'],        adults: 1,  children: 0, infants: 0, checkIn: isoDate(0),   checkOut: isoDate(1),   nights: 1, lodgingAmount: 160000,  paid: 0, status: 'Pendiente' },
    // Próximas
    { guestName: 'Valeria Suárez',         docNumber: '1150708090', phone: '+57 319 135 7911', email: 'valeria.suarez@email.com',   city: 'Colombia - Cali, Valle del Cauca', reservationType: 'Individual',      lodgingType: 'Habitación',    rooms: ['202'],        adults: 1,  children: 0, infants: 1, checkIn: isoDate(2),   checkOut: isoDate(3),   nights: 1, lodgingAmount: 180000,  paid: 90000,   method: 'Daviplata', status: 'Confirmada' },
